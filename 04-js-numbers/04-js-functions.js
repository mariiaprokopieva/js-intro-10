...
console.log(123.23.toFixed(1)); // 123.2 - keeps amount of decimals we set
console.log(123.23.toPrecision(3)); // 123 - keeps amount of digits
...
console.log(Number.isInteger(54254736529765243765235629856982375623986587)); // true
console.log(Number.isSafeInteger(54254736529765243765235629856982375623986587)); // false
