...
const convertTemperature = (tempValue, unit) => {
    if(unit === 'Celsius') return ( tempValue * 9 / 5 ) + 32;
    else if(unit === 'Fahrenheit') return ( tempValue - 32 ) * 5 / 9;
    else throw Error('Wrong unit type entered');
}
